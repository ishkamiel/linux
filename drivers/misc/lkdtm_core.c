...
struct crashtype crashtypes[] = {
	...
	CRASHTYPE(MPX_BOUNDS_LOAD),
	CRASHTYPE(MPX_BOUNDS_FUNC_EXTERN),
	CRASHTYPE(MPX_BOUNDS_FUNC_INLINE),
	CRASHTYPE(MPX_BOUNDS_FUNC_STATIC),
	CRASHTYPE(MPX_BOUNDS_FUNC_NON_STATIC),
	CRASHTYPE(MPX_BOUNDS_WRAPPER),
	CRASHTYPE(MPXK_BND_BASIC),
	CRASHTYPE(MPXK_BND_ARRAY),
	CRASHTYPE(MPXK_BND_FUNC10)
#endif
};
